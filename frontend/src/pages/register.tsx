                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className="mt-1 w-full rounded-md border border-gray-200 bg-white px-3 py-2 pr-10 text-sm outline-none focus:border-gray-300 focus:ring-2 focus:ring-gray-200"
                    />
                    <button
                      type="button"
